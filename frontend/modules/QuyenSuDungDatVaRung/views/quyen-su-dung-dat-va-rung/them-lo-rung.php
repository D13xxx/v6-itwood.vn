...
$this->title = Yii::t('frontend', 'Quyền sử dụng đất - Thêm lô rừng');
    ...
    <div class="reg-quyen-su-dung-dat-form">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="col-sm-4">
                    <?= $form->field($model,'ma')->textInput(['readonly'=>true])?>
                </div>
                <div class="col-sm-8">
                    <?php
                    ...
                    <?= $form->field($model,'quyen_su_dung_dat_id')->widget(\kartik\select2\Select2::className(),[
                        ...
                        'pluginOptions'=>['allowClear'=>true,'readOnly'=>true]
                    ])?>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <?= $form->field($model, 'ngay_ban_hanh')->textInput(['maxlength' => true,'readonly'=>true,'value'=>date("d/m/Y",strtotime($model->ngay_ban_hanh))]) ?>
                </div>
                <div class="col-sm-4">
