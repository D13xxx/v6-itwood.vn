...
<div class="reg-ho-so-go-create">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="col-sm-12">
                <?= $form->field($model, 'ma')->textInput(['maxlength' => true,'readonly'=>true,'value'=>uniqid()]) ?>
            </div>
            <?php
        ...
        <div class="panel-footer">
            <?= Html::submitButton(Yii::t('frontend', 'Thêm chi tiết'), ['class' => 'btn btn-primary','name'=>'luuThongTin','value' => 'create_update']) ?>

            <?= Html::a(Yii::t('frontend','Quay lại'),['ho-so-moi'],['class'=>'btn btn-default'])?>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
</div>
