...
<div class="panel panel-primary">
    ...
    <div class="panel-footer">
        ...
        if($model->trang_thai_id != \common\models\RegHoSoXinKhaiThac::TT_HOSO_KHONGDUYET){
            ...
            echo Html::button(Yii::t('backend', 'Không duyệt hồ sơ'), ['id' => 'modelButton', 'value' => \yii\helpers\Url::to(['/ho-so-go/xet-duyet-ho-so-go/khong-duyet-ho-so', 'id' => $model->id]), 'class' => 'btn btn-danger']);
        }
        ?>
...
\yii\bootstrap\Modal::begin([
    'header' => '<h4>Không duyệt hồ sơ Gỗ</h4>',
    'id'     => 'model',
    'size'   => 'model-lg',
]);
