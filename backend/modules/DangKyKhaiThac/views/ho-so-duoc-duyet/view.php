...
?>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <?= \yii\jui\Tabs::widget([
                'items'=>[
                    ...
                    [
                        'label'=>Yii::t('frontend','Lịch sử Hồ sơ đăng ký khai thác'),
        ...
        <div class="panel-body">
            <?= Html::a(Yii::t('backend', 'In hồ sơ'), ['/dang-ky-khai-thac/in-ho-so', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
            <?= Html::a(Yii::t('backend','Quay lại'),['/dang-ky-khai-thac/ho-so-duoc-duyet'],['class'=>'btn btn-default'])?>
        </div>
    </div>
    <div class="clearfix"></div>
<?php
