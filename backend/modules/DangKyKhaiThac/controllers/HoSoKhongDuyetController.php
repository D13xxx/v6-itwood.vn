...
class HoSoKhongDuyetController extends \yii\web\Controller
{
    public function actionIndex()
    {
        $searchModel = new RegHoSoXinKhaiThacSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataProvider->query->andWhere(['reg_ho_so_xin_khai_thac.trang_thai_id'=>RegHoSoXinKhaiThac::TT_HOSO_KHONGDUYET]);
