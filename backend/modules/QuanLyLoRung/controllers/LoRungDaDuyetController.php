...
use common\models\searchs\RegLoRungPhucTraSearch;
...
class LoRungDaDuyetController extends \yii\web\Controller
{
    public function actionIndex()
    {
        ...
        $dataProvider->query->andWhere(['reg_lo_rung.trang_thai_id'=>RegLoRung::TT_RUNGDUOCDUYET]);
    ...
    public function actionView($id)
    {
        ...
        $searchLoRungPhucTra = new RegLoRungPhucTraSearch();
        $dataPhucTra = $searchLoRungPhucTra->search(Yii::$app->request->queryParams);
        $dataPhucTra->query->andWhere(['reg_lo_rung_id'=>$model->id]);

        return $this->render('view',[
            'model'=>$model,
            'modelQSD'=>$modelQSD,
            'modelChuThe'=>$modelChuThe,
            'dataPhucTra'=>$dataPhucTra,
        ]);
    }
