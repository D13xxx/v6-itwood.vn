...
//                            } else {
//                                return Html::a(Yii::t('backend','Kiểm tra trên FORMIS'),['#'],['class'=>'btn btn-primary btn-block']);
//                            }
//                        }
//                    ],
                ],
    ...
    <div class="panel-footer">
        <?= Html::button(Yii::t('backend', 'Duyệt lô rừng'),
            [
                'value'=> \yii\helpers\Url::to(['/quan-ly-lo-rung/phuc-tra/duyet','id'=>$model->id]),
                'id'=>'buttonDuyetLoRung',
...
//Modal dành cho Duyệt lô rừng
\yii\bootstrap\Modal::begin([
    'id' => 'DuyetLoRung',
    'header' => '<h4 style="text-align: center">'.Yii::t('backend','Duyệt lô rừng sau khi phúc tra').'</h4>',
    'size'=>'modal-lg',
]);
echo '<div id="modalDuyetLoRung">';
...
$scriptModal = <<< JS
    ...
    $(function() {
        $('#buttonDuyetLoRung').click(function() {
            $('#DuyetLoRung').modal('show')
            .find('#modalDuyetLoRung').load($(this).attr('value'));
        })
    })
