...
/**
 * This is the model class for table "reg_ho_so_xin_khai_thac_giao_dich".
 *
 * @property int $id
 ...
 */
class RegHoSoXinKhaiThacGiaoDich extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'reg_ho_so_xin_khai_thac_giao_dich';
    }
    ...
    {
        return [
            [['reg_chu_the_cu_id', 'reg_chu_the_moi_id', 'loai_chu_the_id', 'reg_ho_so_xin_khai_thac_id'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\querys\RegHoSoXinKhaiThacGiaoDichQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\querys\RegHoSoXinKhaiThacGiaoDichQuery(get_called_class());
    }
}
