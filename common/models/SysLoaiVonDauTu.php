...
/**
 * This is the model class for table "sys_loai_von_dau_tu".
 *
 * @property int $id
 * @property string $ten
 ...
 */
class SysLoaiVonDauTu extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\querys\SysLoaiVonDauTuQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\querys\SysLoaiVonDauTuQuery(get_called_class());
    }
}
