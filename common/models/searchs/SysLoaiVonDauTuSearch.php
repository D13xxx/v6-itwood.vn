...
/**
 * SysLoaiVonDauTuSearch represents the model behind the search form of `common\models\SysLoaiVonDauTu`.
 */
class SysLoaiVonDauTuSearch extends SysLoaiVonDauTu
{
    /**
     * {@inheritdoc}
     */
