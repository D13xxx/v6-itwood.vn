...
/**
 * RegHoSoGoGhepTempSearch represents the model behind the search form of `common\models\RegHoSoGoGhepTemp`.
 */
class RegHoSoGoGhepTempSearch extends RegHoSoGoGhepTemp
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'khoi_luong_da_dung' => $this->khoi_luong_da_dung,
        ]);
