...
/**
 * RegChuTheHoGiaDinhKhongDuyetSearch represents the model behind the search form of `common\models\RegChuTheHoGiaDinhKhongDuyet`.
 */
class RegChuTheHoGiaDinhKhongDuyetSearch extends RegChuTheHoGiaDinhKhongDuyet
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = RegChuTheHoGiaDinhKhongDuyet::find();
