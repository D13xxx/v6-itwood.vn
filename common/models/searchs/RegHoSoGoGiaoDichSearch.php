...
/**
 * RegHoSoGoGiaoDichSearch represents the model behind the search form of `common\models\RegHoSoGoGiaoDich`.
 */
class RegHoSoGoGiaoDichSearch extends RegHoSoGoGiaoDich
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'reg_chu_the_cu_id', 'reg_chu_the_moi_id', 'loai_chu_the_id', 'reg_ho_so_go_id'], 'integer'],
