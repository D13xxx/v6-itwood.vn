...
/**
 * QuanHuyenSearch represents the model behind the search form of `common\models\QuanHuyen`.
 */
class QuanHuyenSearch extends QuanHuyen
{
    ...
    public function rules()
    {
        return [
            ...
            [['ma', 'ten', 'ngay_xoa','tinh_thanh_id'], 'safe'],
        ];
    }
...
//            'tinh_thanh_id' => $this->tinh_thanh_id,
        ...
        $query->andFilterWhere(['like', 'ma', $this->ma])
            ...
            ->andFilterWhere(['like', 'tinh_thanh.ten', $this->tinh_thanh_id]);
